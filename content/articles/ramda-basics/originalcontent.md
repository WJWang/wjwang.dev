...
evenListFilter([1, 3, 4, 5, 7, 2, 10]) // [4, 2, 10]
```
...
evenSquare([1, 3, 5, 4, 9, 10, 22]); // [16, 100, 484]
```

### compose : associativity => f・g(h(x)) = f(g(x)) ・h
...
composeB([2, 3, 4]); // [2, 3, 4, 5] => [2, 4] => [4, 16] => [8, 32]
```
