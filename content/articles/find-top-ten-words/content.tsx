...
export default function Content() {
  return (
    <Prose>
      ...
      <CodeBlock language="java" filename="start.java">{`package topten;
...
public class start extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
      ...
      <h3>CountKeyword.java</h3>

      <CodeBlock language="java" filename="CountKeyword.java">{`package topten;
...
public class CountKeyword {
	...
	public static class CountReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
      ...
      <h3>GetTopTen.java</h3>

      <CodeBlock language="java" filename="GetTopTen.java">{`package topten;
...
public class GetTopTen {
	...
	public static class TopTenReducer extends Reducer<NullWritable, Text, IntWritable, Text> {
      ...
      <p>原文發表於 <a href="https://wjwang.medium.com/find-the-top-ten-words-a17b3ecc9be">Medium</a></p>
    </Prose>
  );
}
